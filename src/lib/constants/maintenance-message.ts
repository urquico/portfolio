// This constant is used to display a maintenance message for the About Me page. It includes an emoji, title, subtitle, and description.
...
// This constant is used to display a maintenance message for the Projects page. It includes an emoji, title, subtitle, and description.
...
// This constant is used to display a maintenance message for the Stacks page. It includes an emoji, title, subtitle, and description.
...
// This constant is used to display a maintenance message for the Contacts page. It includes an emoji, title, subtitle, and description.
